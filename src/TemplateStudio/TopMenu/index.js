...
class TopMenu extends React.Component {
  ...
  render() {
    const EMPTY_CONTRACT_TEMPLATE = `${ROOT_URI}/static/archives/empty-contract@0.5.0.cta`;
    const EMPTY_CLAUSE_TEMPLATE = `${ROOT_URI}/static/archives/empty@0.6.0.cta`;
    ...
    return (
      <Menu fixed="top" inverted style={{ background: '#1b2540'}}>
        <Container fluid>
          ...
          <Menu.Item>
            <Popup content='Template Studio Compatible with Cicero 0.21' trigger={<Button inverted color="red" style={{ marginLeft: '1em' }} href="https://studio.accordproject.org">Switch to Version 0.21</Button>} />
          </Menu.Item>
        </Container>
      </Menu>
    );
